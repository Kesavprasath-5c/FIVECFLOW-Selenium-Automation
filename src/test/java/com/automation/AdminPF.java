...
public class AdminPF {
    ...
    public void Rad_case_Assignment() throws Exception {
		...
		WebElement casestudies = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Case Studies']")));
		if(casestudies.isDisplayed()) {
		WebElement search = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@alt='icon_search']")));
		search.click();
		Thread.sleep(1000);
